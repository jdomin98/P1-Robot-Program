...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'beginner_tutorials' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/turtlebot-b213/Turtlebot_Code_ws/install/${idir}'.  Ask the maintainer 'turtlebot-b213 <turtlebot-b213@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/turtlebot-b213/Turtlebot_Code_ws/install/lib;/home/turtlebot-b213/Turtlebot_Code_ws/devel/lib;/opt/ros/kinetic/lib)
